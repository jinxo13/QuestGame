...
class db(object):
    ...
    def _connect(self):
        if constants.DB_LOCAL:
            return boto3.resource('dynamodb',
                              aws_access_key_id="anything",
                              aws_secret_access_key="anything",
                              region_name="us-west-2",
                              endpoint_url="http://10.1.3.200:8000")
        else:

            return boto3.resource('dynamodb',
                              aws_access_key_id="AKIAJ5LA2EVPAITX6FQQ",
                              aws_secret_access_key="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",
                              region_name="us-west-2")
